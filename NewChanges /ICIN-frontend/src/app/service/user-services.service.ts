...
import { Loan } from '../loan-request/loan-request.component';
...
export class UserServicesService {
  ...
  requestLoan(chequeObj:Loan,userObj:User){
    let objs = {
      "loan":chequeObj,
      "user":userObj
    }
    return this.http.post("http://localhost:8090//createloan",chequeObj);
  }

...
public class RegistrationTest {
	...
	public void registerUser() throws InterruptedException {
		...
		//Personal Details
		driver.findElement(By.cssSelector("input[name='firstName'")).sendKeys("Meet1");
		driver.findElement(By.cssSelector("input[name='lastName'")).sendKeys("Shah1");
		...
		//User Registration
		driver.findElement(By.cssSelector("input[name='userName'")).sendKeys("meetshah1333");
		driver.findElement(By.cssSelector("input[name='password'")).sendKeys("Abc@12345");
		driver.findElement(By.cssSelector("input[name='confirm_password'")).sendKeys("Abc@12345");
